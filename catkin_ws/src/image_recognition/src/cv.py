...
template = []
names = ["No Image", "Barack Obama", "Avril Lavigne", "Some Chinese Dude", "Legolas", "Levi"]
template.append(cv2.cvtColor(cv2.imread('/home/jdsantos/catkin_ws/src/picture/Obama.png'), cv2.COLOR_BGR2GRAY))
template.append(cv2.cvtColor(cv2.imread('/home/jdsantos/catkin_ws/src/picture/Avril.png'), cv2.COLOR_BGR2GRAY))
template.append(cv2.cvtColor(cv2.imread('/home/jdsantos/catkin_ws/src/picture/Someone.png'), cv2.COLOR_BGR2GRAY))
template.append(cv2.cvtColor(cv2.imread('/home/jdsantos/catkin_ws/src/picture/Legolas.png'), cv2.COLOR_BGR2GRAY))
template.append(cv2.cvtColor(cv2.imread('/home/jdsantos/catkin_ws/src/picture/Levi.png'), cv2.COLOR_BGR2GRAY))
